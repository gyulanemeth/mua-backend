...
describe('Accounts login test ', () => {
  ...
  beforeAll(async () => {
    ...
    process.env.BLUEFOX_TEMPLATE_ADMIN_VERIFY_EMAIL_ID = '123123'
    process.env.BLUEFOX_TEMPLATE_ADMIN_FORGOT_PASSWORD_ID = '123123'
    process.env.BLUEFOX_TEMPLATE_ADMIN_INVITATION_ID = '123123'
